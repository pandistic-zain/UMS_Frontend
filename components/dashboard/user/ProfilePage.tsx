...
export default function ProfilePage() {
  ...
  const displayName = user?.name || "UMS User";
  const displayEmail = user?.email || "user@ums.com";
      ...
      <header className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-2 text-sm text-slate-500">
            A snapshot of your current standing and activity.
          </p>
        </div>
        <a
          href="/user/settings"
        ...
        <div className="rounded-3xl border border-blue-100 bg-white p-6 shadow-sm">
          <div className="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-4">
              <div className="h-20 w-20 overflow-hidden rounded-3xl border border-blue-100 bg-blue-50">
                <img src={avatarUrl} alt="User avatar" className="h-full w-full object-contain" />
              </div>
              <div>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-2">
            <div className="rounded-2xl border border-blue-50 p-4">
              ...
              <p className="mt-2 text-sm font-semibold text-ink">USER</p>
            </div>
            <div className="rounded-2xl border border-blue-50 p-4">
        ...
        <div className="rounded-3xl border border-blue-100 bg-white p-6 shadow-sm space-y-4">
          <div>
            ...
            <p className="text-xs text-slate-500">
              Shows how you are standing across recent obligations and payments.
            </p>
          </div>
