          ...
          <div className="relative w-full mt-4 max-w-xl mx-auto">
            ...
            {!files.length && (
              <motion.div
                ...
                className={cn(
                  "relative group-hover/file:shadow-2xl z-40 bg-white dark:bg-neutral-900 flex items-center justify-center h-24 mt-3 w-full max-w-[7rem] mx-auto rounded-md",
            ...
            {!files.length && (
              <motion.div
                ...
                className="absolute opacity-0 border border-dashed border-sky-400 inset-0 z-30 bg-transparent flex items-center justify-center h-24 mt-3 w-full max-w-[7rem] mx-auto rounded-md"
              ></motion.div>
            )}
          </div>
        </div>
...
export function GridPattern() {
  ...
  const rows = 6;
  return (
    <div className="flex bg-gray-100 dark:bg-neutral-900 shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-100">
